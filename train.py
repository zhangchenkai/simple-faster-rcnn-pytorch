...
sys.path.append('/home/nico/PycharmProjects/project-marvel/models-collection/simple_faster_rcnn')
...
def train(**kwargs):
    ...
    trainset = TrainDataset(opt, p_id=1)
    print('load data')
    ...
    testset = TestDataset(opt, p_id=1)
